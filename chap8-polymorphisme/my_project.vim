...
vmap 	 >gv
map  :w
map ,date :let @z=strftime("%d %b %Y")"zpa
map ,datetime :let @z=strftime("%d %b %Y %X")"zpa
map ,L :let @z=TimeStamp()"zpa
vnoremap < <gv
vnoremap > >gv
map Q gq
map \s :Sexplore 
...
silent only
cd ~/boulot/c++/chap8-polymorphisme
...
badd +0 Garage.cpp
badd +0 Garage.h
badd +258 /usr/share/vim/vim72/doc/tabpage.txt
badd +1024 my_project.vim
badd +0 0
badd +0 Camion.cpp
badd +0 Camion.h
args Class.cpp
